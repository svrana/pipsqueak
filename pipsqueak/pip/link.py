...
class Link(object):
    ...
    @property
    def filename(self):
        _, netloc, path, _, _ = urlsplit(self.url)
    ...
    @property
    def path(self):
        return unquote(urlsplit(self.url)[2])
    ...
    def url_without_fragment(self):
        scheme, netloc, path, query, _ = urlsplit(self.url)
