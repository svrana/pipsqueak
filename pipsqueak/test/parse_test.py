    ...
    def test_from_file(self):
        with req_file("./test_requirements_000.txt", "tornado<=6.0\n"):
            ...
            self.assertEqual(reqs['tornado'], default_desc(
                ...
                source=os.path.join(os.path.abspath(os.path.curdir),
                                    "test_requirements_000.txt"),
                specifiers="<=6.0",
                line_number=1,
            ))
